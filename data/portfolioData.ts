      ...
      troubleshooting: [
        {
          ...
          problem:
            "useSession()은 클라이언트 전용 훅으로, 서버 컴포넌트에서 호출 시 세션이 null로 반환되어 인증 의존 로직이 동작하지 않았습니다.",
          solution:
            "getServerSession()으로 교체해 App Router 서버 환경에서도 안정적으로 세션을 조회할 수 있도록 구조를 개선했습니다.",
        },
        {
          ...
          solution:
            "낙관적 업데이트를 적용해 즉각적인 UI 반응성을 확보하고, 요청 완료 전 추가 클릭을 차단해 중복 요청을 방지했습니다.",
        },
      ],
    },
  },
